    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {(config.source_type === 'coinpool' || config.source_type === 'mixed') && (
        <div className="space-y-3 sm:space-y-4">
          {/* Header Row: Title on left, Checkbox on right */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 pb-2 border-b" style={{ borderColor: '#2B3139' }}>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <label className="flex items-center gap-1.5 sm:gap-2 cursor-pointer">
                ...
                />
                <span className="text-xs sm:text-sm whitespace-nowrap" style={{ color: '#EAECEF' }}>{t('useCoinPool')}</span>
              </label>
          ...
          {/* API URL Section - Only show when enabled */}
          {config.use_coin_pool && (
      ...
      {(config.source_type === 'oi_top' || config.source_type === 'mixed') && (
        <div className="space-y-3 sm:space-y-4">
          {/* Header Row: Title on left, Checkbox and Limit on right */}
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 pb-2 border-b" style={{ borderColor: '#2B3139' }}>
            <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
              <label className="flex items-center gap-1.5 sm:gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 sm:w-5 sm:h-5 rounded accent-yellow-500 flex-shrink-0"
                />
                <span className="text-xs sm:text-sm whitespace-nowrap" style={{ color: '#EAECEF' }}>{t('useOITop')}</span>
              </label>
              {config.use_oi_top && (
                <div className="flex items-center gap-1.5 sm:gap-2">
                  <span className="text-xs sm:text-sm whitespace-nowrap" style={{ color: '#848E9C' }}>
