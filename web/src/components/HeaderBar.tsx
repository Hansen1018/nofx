          ...
          <div className="flex items-center gap-4">
            ...
            {isLoggedIn && user ? (
              <div className="flex items-center gap-3">
                ...
                <div className="relative" ref={userDropdownRef}>
                  ...
                  {userDropdownOpen && (
                    <div className="absolute right-0 top-full mt-2 w-48 rounded-lg shadow-lg overflow-hidden z-50 bg-[#0B0E11]/95 backdrop-blur-xl border border-nofx-gold/20" style={{ WebkitBackdropFilter: 'blur(24px)', backdropFilter: 'blur(24px)' }}>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {languageDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-32 rounded-lg shadow-lg overflow-hidden z-50 bg-[#0B0E11]/95 backdrop-blur-xl border border-nofx-gold/20" style={{ WebkitBackdropFilter: 'blur(24px)', backdropFilter: 'blur(24px)' }}>
                  <button
                    onClick={() => {
                      onLanguageChange?.('zh')
                      setLanguageDropdownOpen(false)
          ...
          >
            ...
            >
              ...
              <div className="mt-auto space-y-8 pb-8">
                ...
                {/* Account / Lang */}
                <div className="grid grid-cols-2 gap-4 bg-zinc-900/50 rounded-lg p-4 border border-zinc-800/50">
                  {/* Lang Switcher */}
                    ...
                    {['zh', 'en'].map((lang) => (
                      <button
                        ...
                        className={`flex-1 py-3 text-sm font-bold rounded-md transition-colors ${
                          language === lang
                            ? 'bg-nofx-gold text-black shadow-sm'
                  ...
                  {isLoggedIn && user ? (
                    <button
                      ...
                      className="bg-red-500/20 border border-red-500/40 text-red-400 rounded-lg font-bold text-sm hover:bg-red-500/30 transition-colors py-3"
                    >
                      {t('exitLogin', language)}
                    </button>
                  ) : (
