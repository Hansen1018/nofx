          ...
          <div className="flex items-center gap-4">
            ...
            {isLoggedIn && user ? (
              <div className="flex items-center gap-3">
                ...
                <div className="relative" ref={userDropdownRef}>
                  ...
                  {userDropdownOpen && (
                    <div className="absolute right-0 top-full mt-2 w-48 rounded-lg shadow-lg overflow-hidden z-50 bg-[#0B0E11] backdrop-blur-xl border border-nofx-gold/20">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {languageDropdownOpen && (
                <div className="absolute right-0 top-full mt-2 w-32 rounded-lg shadow-lg overflow-hidden z-50 bg-[#0B0E11] backdrop-blur-xl border border-nofx-gold/20">
                  <button
                    onClick={() => {
                      onLanguageChange?.('zh')
                      setLanguageDropdownOpen(false)
