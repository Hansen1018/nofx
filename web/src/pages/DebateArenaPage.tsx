...
<<<<<<< HEAD
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-48 h-48 md:h-auto flex-shrink-0 bg-nofx-bg/30 backdrop-blur-sm border-b md:border-b-0 md:border-r border-nofx-gold/20 flex flex-col md:flex-none z-10">
        {/* New Debate Button */}
        <button
