...
=======
		...
		"claude":   {url: "https://api.anthropic.com/v1", model: "claude-opus-4-8"},
>>>>>>> 745cc8be (feat: add Claude Opus 4.8 model support)
		...
		"minimax":  {url: "https://api.minimax.chat/v1", model: "MiniMax-M3"},
